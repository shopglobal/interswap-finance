...
const ActionPanel: React.FunctionComponent<ActionPanelProps> = ({ details, apr, multiplier, liquidity }) => {
  ...
  const { quoteTokenAdresses, tokenAddresses, quoteContract, tokenSymbol, dual } = farm
  ...
  return (
    <Container>
      <InfoContainer>
        <StakeContainer>
          <StyledLinkExternal href={`https://dex.interswap.finance/#/add/${liquidityUrlPathParts}`}>
