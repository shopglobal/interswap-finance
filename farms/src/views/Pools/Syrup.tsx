      ...
      <Hero>
        ...
        <div className="layer" />
          ...
          <Heading as="h1" size="xxl" mb="16px">
            {TranslateString(738, 'Get Interchained!')}<br />
            {TranslateString(738, 'Explore Binance Smart Chain. . . ')}
          </Heading>
          <ul>
            <li>{TranslateString(580, 'Stake tokens to earn new tokens.')}</li>
            <li>{TranslateString(486, 'Stake or unstake at any time.')}</li>
            <li>{TranslateString(406, 'Rewards are distributed with every mined block on Binance Smart Chain.')}</li>
          </ul>
