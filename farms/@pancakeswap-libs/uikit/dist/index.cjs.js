...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 105 26" }, props),
        React__default['default'].createElement("image", { width: "100%", height: "26", href: '/images/156x25.svg' })));
};
...
var socials = [
    ...
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/buy_lynx",
    },
];
var MENU_HEIGHT = 64;
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://pancakeswap.info/token/0x7155aFF27df20F9B0ecF8406A5A60c30043894Ec", target: "_blank" },
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#d1e0df" , backgroundDisabled: "#E9EAEB" , contrast: "#191326" , invertedContrast: "#FFFFFF", input: "#eeeaf4" , inputSecondary: "#d7caec", tertiary: "#EFF4F5" , text: "#452A7A" , textDisabled: "#BDC2C4" , textSubtle: "#5500ff" , borderColor: "#E9EAEB" , card: "#FFFFFF" , gradients: {
