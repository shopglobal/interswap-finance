...
import { useFarms, usePriceCakeBusd, usePriceBnbBusd, usePriceCakeOGBusd, usePriceEthusd, usePriceATOMusd} from 'state/hooks'
...
const EarnAPYCard = () => {
  ...
  const calculateAPY = useCallback(
    ...
    [bnbPrice, cakeOGPrice, ethPrice, atomPrice, cakePrice, farmsLP],
  )
